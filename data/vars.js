...
module.exports = {
  ...
  skills: {
    left: [
      ...
      { name: 'Art', value: 0, ruffle: 1 },
      { name: 'Barter', value: 5 },
      { name: 'Craft', value: 0, ruffle: 2 },
      { name: 'Deception', value: 10 },
      { name: 'Disguise', value: 5 },
      { name: 'Dodge', value: 20, ruffle: 1 },
  ...
  spellLevels: [
    ...
    {soft: 'finesseClassLvlSpell', txt: 'Finesse & Class'},
    {soft: 'cantripLvlSpell', txt: 'Cantrips'},
